...
export default function ExamplePassportPage() {
  return (
    <PassportTemplate
      groomName="Diego"
      brideName="Sofía"
      ...
      accepts_kids={true}
      accepts_pets={false}
      couple_code="DIEGOSOFIA2024"
      store="https://listaderegalos.com/diego-sofia"
      wishListItems={[
        {
          id: "1",
