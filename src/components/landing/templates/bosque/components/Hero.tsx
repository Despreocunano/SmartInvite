      ...
      <div className="absolute -top-16 md:-top-32 left-1/2 transform -translate-x-1/2 z-20 w-48 h-48 md:w-56 md:h-56 lg:w-96 lg:h-96">
        ...
        >
          <motion.img
            ...
            className="absolute top-4 left-0 w-full h-full object-contain opacity-90"
            custom={0}
          ...
          <motion.img
            src={topFlowers_b}
            alt="Floral decoration 1"
            className="absolute -top-6 left-28 lg:left-60 w-full h-full object-contain opacity-90"
            custom={1}
            variants={topImagesVariants}
          />
                    <motion.img
      ...
      <div className="relative z-10 w-full min-h-screen flex items-center justify-center px-4">
        <div className="text-center text-white max-w-4xl mx-auto w-full">
          ...
          {welcomeMessage && (
            ...
            >
              <div className="w-full h-px bg-white/60 mx-auto mb-6"></div>
              <blockquote className="text-xl md:text-2xl font-light italic leading-relaxed">
                "{welcomeMessage}"
              </blockquote>
              <div className="w-full h-px bg-white/60 mx-auto mt-6"></div>
            </motion.div>
          )}
        </div>
      </div>
