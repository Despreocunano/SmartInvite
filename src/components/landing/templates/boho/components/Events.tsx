  ...
  return (
    ...
    >
      <div className="relative flex flex-col items-center w-full">
        ...
        <h3 className="relative z-10 text-6xl font-ivyora text-[#985E4C] text-center mb-6">
          {title}
        </h3>
      </div>
        <div className="p-0 md:p-10 pt-0 space-y-8">
          <div className="space-y-4 text-center">
            <h4 className="text-3xl font-sans text-[#985E4C] mb-2">Lugar</h4>
            <div className="flex flex-col items-center">
              <p className="text-sm md:text-lg font-sans text-[#985E4C]">{location}</p>
            </div>
          </div>

          <div className="space-y-2 text-center">
            <h4 className="text-5xl font-sans text-[#985E4C] mb-2">Día</h4>
            <div className="flex items-center justify-center gap-4">
              <p className="text-sm md:text-lg font-sans text-[#985E4C]">
              ...
              {time && (
                <span className="font-lora text-[#985E4C]">•</span>
              )}
              {time && (
                <span className="text-sm md:text-lg font-sans text-[#985E4C]">{time}</span>
              )}
            </div>
          </div>
          ...
          {address && (
          <div className="space-y-4 text-center">
            <h4 className="text-5xl font-sans text-[#985E4C] mb-2">Dirección</h4>
              <div className="flex flex-col items-center">
                <p className="text-sm md:text-lg font-sans text-[#985E4C]">{address}</p>
              </div>
            <Button
              onClick={handleOpenMaps}
              className="bg-[#985E4E] hover:bg-[#985E4E]/80 text-white px-6 py-2 w-48 mx-auto rounded-xl font-sans"
            >
              ¿Cómo llegar?
            </Button>
          </div>
    ...
    <>
      <section className={`px-4 w-full ${className}`}>
        <motion.div 
          ...
          variants={container}
        >
          <div className="bg-[#f9f6f2] w-full max-w-4xl mx-auto items-center justify-center px-8 py-16 grid md:grid-cols-2 gap-8">
              ...
              <div className="p-8 md:p-10 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Button
                    ...
                    className="bg-[#985E4E] hover:bg-[#985E4E]/80 text-white px-2 py-2 w-full mx-auto rounded-xl font-sans"
                  >
                  ...
                  <AnimatePresence>
                    {showCalendarOptions && (
                      <motion.div 
                        ...
                        exit={{ opacity: 0, y: -10 }}
                        className="col-span-1 md:col-span-2 mt-2 bg-[#985E4E] border border-[#CFD6BA]/20 rounded-lg shadow-lg p-2"
                      >
                        <motion.a
