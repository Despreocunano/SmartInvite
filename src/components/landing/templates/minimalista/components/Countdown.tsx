    ...
    <section className={`py-24 px-0 w-full ${className}`}>
      ...
      >
        ...
        <motion.div 
          ...
          variants={item}
        >
          <h2 className="text-4xl md:text-5xl font-poppins text-[#B87600] mb-4">Faltan</h2>
        </motion.div>
          ...
          >
            <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-8 text-center relative overflow-hidden">
              <div className="relative z-10">
                <div className="text-6xl font-bold text-[#333333] mb-3 font-rubik">
                  {timeLeft.days}
                </div>
                <div className="text-[#8D6E63] text-sm uppercase tracking-wider font-rubik">
                  días
                </div>
              </div>
            </div>
