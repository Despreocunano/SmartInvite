  ...
  return (
    <>
      ...
      >
        ...
        >
         < GiftsIcon /> 
          <h2 className="text-7xl md:text-8xl font-carattere text-[#C49C79] mb-6">Mesa de Regalos</h2>
           <div className='max-w-4xl mx-auto mb-8'>        
          <motion.p 
            className="text-2xl text-center font-sans text-white"
            variants={item}
          >
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center">
            {showBankInfo && bankInfo && (
              <motion.button
                ...
                className="bg-[#2e424b] rounded-xl p-8 shadow-lg border border-[#CFD6BA]/20 w-full md:w-[400px]"
                variants={item}
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                <h3 className="text-xl font-sans mb-2 text-[#CFD6BA]">Datos Bancarios</h3>
                <p className="text-[#CFD6BA]/80 text-lg mb-2 font-sans">
                  Información para transferencia
                </p>
                <div className="bg-[#CFD6BA]/10 rounded-lg p-3 h-[72px] flex items-center justify-center">
                  <p className="text-[#CFD6BA] text-lg font-sans">
            ...
            {showWishList && wishListItems.length > 0 && (
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
              >
                <h3 className="text-xl font-sans mb-2 text-[#CFD6BA]">Lista de Deseos</h3>
                <p className="text-[#CFD6BA]/80 text-lg mb-2 font-sans">
            ...
            {showCoupleCode && couple_code && store && (
              <motion.div
                ...
                variants={item}
              >
                <h3 className="text-xl font-sans mb-2 text-[#CFD6BA]">Lista de Regalos</h3>
                <p className="text-[#CFD6BA]/80 text-lg mb-2 font-sans">
                  Información de nuestra lista de regalos
                </p>
                <div className="bg-[#CFD6BA]/10 rounded-lg p-3 h-[72px] flex flex-col justify-center">
                  <p className="text-[#CFD6BA] text-lg font-sans">Código: {couple_code}</p>
                  <p className="text-[#CFD6BA]/80 text-sm font-sans">Tienda: {store === 'falabella' ? 'Falabella' : 'Paris'}</p>
                </div>
              </motion.div>
            )}
          </div>
