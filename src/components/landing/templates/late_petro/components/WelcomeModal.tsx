...
export function WelcomeModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#051B24]">
      <div className="relative w-full max-w-3xl px-12 py-12 text-center text-[#2D1B69]">
        {/* Corner decorations */}
        ...
        <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-9xl font-carattere text-[#C49C79]">
              {groomName} & {brideName}
              </h1>
