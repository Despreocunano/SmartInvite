...
export function BohoBotanicoTemplate({
  groomName,
  brideName,
  weddingDate,
  welcomeMessage,
  ...
  return (
    ...
    >
      ...
      <main
        className="font-['Playfair_Display'] w-full min-h-screen"
        style={{
          backgroundImage: "url('/src/components/landing/templates/boho/assets/bg-wedding.png')",
