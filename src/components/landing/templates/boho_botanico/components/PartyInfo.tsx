  ...
  return (
    <>
      ...
      >
        ...
        />
        {/* Bloque principal */}
        <div className="relative z-10 bg-[#F5F7F2] w-full max-w-4xl mx-auto flex flex-col items-center justify-center px-4 lg:px-8 py-16">
          <motion.div 
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Card 1: Dress Code (con imagen decorativa) */}
              {/* Card */}
              <motion.div 
                className="bg-[#869484] rounded-2xl p-8 text-center shadow-lg relative z-10 min-h-[350px] flex flex-col gap-8"
                variants={item}
              >
            ...
            <div className="relative">
              <motion.div 
                className="bg-[#869484] rounded-2xl p-8 text-center shadow-lg relative min-h-[350px] flex flex-col gap-8"
                variants={item}
              >
                ...
                <Button
                  ...
                  variant="secondary"
                  className=" hover:bg-[#F7F6F2]/80 border-[#F7F6F2] text-white hover:text-[#869484] px-6 py-2 w-48 mx-auto rounded-xl font-sans"
                >
                  Sugerir canción
                </Button>
              </motion.div>
