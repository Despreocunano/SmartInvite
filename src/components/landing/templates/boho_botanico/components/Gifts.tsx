...
${bankInfo.email}`;
  ...
  return (
    <>
      ...
      >
        <motion.div 
          className="bg-[#F5F7F2] w-full max-w-4xl mx-auto flex flex-col items-center justify-center px-8 py-16 text-center"
          variants={item}
        >
         < GiftsIcon /> 
          <h2 className="text-6xl font-ivyora text-[#869484] mb-4">Mesa de Regalos</h2>
           <div className='max-w-4xl mx-auto mb-8'>        
          <motion.p 
            className="text-2xl text-center font-sans text-[#869484]"
            variants={item}
          >
          ...
          <div className="flex flex-col gap-4 justify-center">
            {showBankInfo && bankInfo && (
              <motion.button
                ...
                className="bg-[#869484] rounded-xl p-8 shadow-lg border border-[#985e4c]/20 w-full"
                variants={item}
              >
