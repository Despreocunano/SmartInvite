...
export function Hero({
  ...
  return (
    <section className={`relative min-h-screen flex items-center justify-center px-4 ${className}`}>
      ...
      {/* Arco central */}
      <div
        className="relative z-20 bg-[#F5F7F2] rounded-t-full w-full max-w-4xl mx-auto min-h-[90vh] flex flex-col items-center justify-centerp px-4 lg:px-8 py-32 lg:py-20 mt-20"
      >
        <div className="text-center text-[#869484] w-90% lg:w-1/2 mt-20">
          {/* Names */}
          <motion.div 
            className="mb-12"
          ...
          >
            <h1 className="text-5xl md:text-7xl font-normal uppercase font-ivyora">
              {groomName}
              <span className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-[#869484]/30 backdrop-blur-sm rounded-full mx-4 md:mx-8 text-3xl md:text-4xl font-ivyora italic">
                &
              </span> 
              {brideName}
            </h1>
