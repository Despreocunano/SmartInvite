...
export function KidsAndPets({ acceptsKids, acceptsPets, className = '' }: KidsAndPetsProps) {
  ...
  const content = (
    <div className={`grid ${acceptsKids && acceptsPets ? 'grid-cols-1 md:grid-cols-2' : 'grid-cols-1'} gap-8`}>
      {acceptsKids && (
        <motion.div 
          className="bg-[#9DB677] rounded-xl p-8 text-center border border-[#CFD6BA]/20"
          variants={item}
        ...
        >
          ...
          <h3 className="text-3xl font-libre mb-4 text-white">Los Niños Bienvenidos</h3>
          <p className="text-[#404040]/80 text-xl leading-relaxed font-sans">
      ...
      {acceptsPets && (
        ...
        >
          ...
          <h3 className="text-3xl font-libre mb-4 text-white">Pet Friendly</h3>
          <p className="text-[#404040]/80 text-xl leading-relaxed font-sans">
  ...
  return (
    <section className={`p-12 px-4 ${className}`}>
      <motion.div 
