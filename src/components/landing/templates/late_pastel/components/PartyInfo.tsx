      ...
      >
        <div className="max-w-6xl mx-auto">
          <motion.div 
            ...
            variants={item}
          >
            <h2 className="text-7xl md:text-8xl font-carattere text-[#3E3F33] mb-2">
              Información de la Fiesta
            </h2>
            <p className="text-2xl text-center font-sans text-[#767168]">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="relative">
              ...
              {/* Card */}
              <motion.div 
                className="bg-[#A19567] rounded-2xl p-8 text-center shadow-lg relative z-10 min-h-[450px] flex flex-col gap-8"
                variants={item}
              >
                ...
                <Button
                  ...
                  className="bg-[#3E3F33] hover:bg-[#3E3F33]/80 text-white px-6 py-2 w-48 mx-auto rounded-xl font-sans"
                >
                  Ver más
                </Button>
              </motion.div>
