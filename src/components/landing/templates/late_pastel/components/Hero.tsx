  ...
  return (
    <section className={`relative w-full min-h-screen overflow-hidden ${className}`}>
      ...
      <div className="relative z-10 w-full min-h-screen flex items-center justify-center px-4">
        <div className="text-center text-[#3E3F33] max-w-4xl mx-auto w-full">
          {/* Date */}
          <motion.div 
            className="mb-8"
          ...
          >
            <div className="inline-block">
              <div className="w-auto h-px bg-[#3E3F33] mb-4"></div>
              <p className="text-3xl font-light tracking-wider">
                {formattedDate}
              </p>
              <div className="w-auto h-px bg-[#3E3F33] mt-4"></div>
            </div>
          </motion.div>
          ...
          >
            <h1 className="text-7xl md:text-8xl font-light font-carattere text-[#3E3F33]">
              {groomName}
      ...
      {/* Scroll Indicator */}
      <motion.div 
        className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-[#3E3F33] z-10"
        initial={{ opacity: 0 }}
        animate={{ 
          opacity: 1,
          y: [0, 10, 0] 
