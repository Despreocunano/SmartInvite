    ...
    >
      ...
      <div className="relative rounded-xl bg-transparent max-w-md mx-auto">
        <div className="relative -top-8 flex flex-col items-center justify-center w-full mb-4">
          ...
          >
            <h3 className="text-4xl md:text-5xl font-fraunces text-[#333] text-center">
              {title}
            </h3>
          </div>
        </div>
        ...
        <div className="p-8 md:p-10 pt-0 space-y-8">
          <div className="space-y-4 text-center">
            <h4 className="text-5xl font-abril text-[#9cb677] mb-2">Lugar</h4>
            <div className="flex flex-col items-center">
              <p className="text-lg font-opensans text-[#FABE5A]">{location}</p>
            </div>
          </div>

          <div className="space-y-4 text-center">
            <h4 className="text-5xl font-abril text-[#9cb677] mb-2">Día</h4>
            <div className="flex items-center justify-center gap-4">
              <p className="text-lg font-opensans text-[#FABE5A]">
              ...
              {time && (
                <span className="text-lg font-opensans text-[#FABE5A]">•</span>
              )}
              {time && (
                <span className="text-lg font-opensans text-[#FABE5A]">{time}</span>
              )}
            </div>
          </div>
          ...
          {address && (
          <div className="space-y-4 text-center">
            <h4 className="text-5xl font-abril text-[#9cb677] mb-2">Dirección</h4>
              <div className="flex flex-col items-center">
                <p className="text-lg font-opensans text-[#FABE5A]">{address}</p>
              </div>
            <Button
