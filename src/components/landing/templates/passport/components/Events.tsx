    ...
    >
      <div className="relative rounded-xl bg-transparent max-w-md mx-auto">
        <div className="relative w-full">
          <div className="relative -top-8 flex items-center justify-center w-full min-h-[60px] py-4 mb-4">
            <div
              ...
              style={{
                ...
                opacity: 0.7,
                boxShadow: '0 4px 24px 0 #DAA267',
              }}
            />
            <h3 className="relative z-10 text-5xl md:text-6xl font-elsie text-white text-center w-full px-6">
              {title}
            </h3>
          </div>
        </div>
        ...
        <div className="p-0 md:p-10 pt-0 space-y-8">
          <div className="space-y-4 text-center">
            <h4 className="text-5xl font-poppins text-white mb-2">Lugar</h4>
            <div className="flex flex-col items-center">
              <p className="text-lg font-sans text-[#AE7A4F]">{location}</p>
            </div>
          </div>

          <div className="space-y-4 text-center">
            <h4 className="text-5xl font-poppins text-white mb-2">Día</h4>
            <div className="flex items-center justify-center gap-4">
              <p className="text-lg font-sans text-[#AE7A4F]">
              ...
              {time && (
                <span className="text-lg font-sans text-[#AE7A4F]">{time}</span>
              )}
            </div>
          </div>
          ...
          {address && (
          <div className="space-y-4 text-center">
            <h4 className="text-5xl font-poppins text-white mb-2">Dirección</h4>
              <div className="flex flex-col items-center">
                <p className="text-lg font-sans text-[#AE7A4F]">{address}</p>
              </div>
            <Button
              onClick={handleOpenMaps}
              className="bg-[#E5D7A9] hover:bg-[#D0C293] text-[#000] px-6 py-2 w-48 mx-auto rounded-full text-base font-sans"
            >
              ¿Cómo llegar?
            </Button>
          </div>
...
END:VCALENDAR`;
  ...
  return (
    <>
      <section className={`pb-0 px-4 w-full ${className}`}>
        <motion.div 
          ...
          variants={container}
        >
          <img src={lineas} alt="Líneas decorativas" className="w-full h-auto mb-20 opacity-50" />
              ...
              <div className="p-8 md:p-10 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Button
                    ...
                    className="bg-[#E5D7A9] hover:bg-[#D0C293] text-[#000] px-6 py-2 w-full rounded-full text-base font-sans"
                  >
                  ...
                  <AnimatePresence>
                    {showCalendarOptions && (
                      <motion.div 
                        ...
                        exit={{ opacity: 0, y: -10 }}
                        className="col-span-1 md:col-span-2 mt-2 bg-[#4C1C1D] border border-[#CFD6BA]/20 rounded-lg shadow-lg p-2"
                      >
                        <motion.a
