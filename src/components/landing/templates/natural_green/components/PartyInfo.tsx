...
import grassBg from '../assets/left-flower.png';
  ...
  return (
    <>
      ...
      >
        ...
        />
        {/* Bloque principal */}
        <div className="relative z-10 bg-[#EFEEE8] w-full max-w-3xl mx-auto flex flex-col items-center justify-center px-4 lg:px-8 py-16">
          <motion.div 
            className="text-center mb-16"
            variants={item}
          >
            <h2 className="text-6xl font-ivyora text-[#708565] mb-4">
              Información de la Fiesta
            </h2>
            <p className="text-2xl text-center font-sans text-[#708565]">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Card 1: Dress Code (con imagen decorativa) */}
              {/* Card */}
              <motion.div 
                className="bg-[#708565] rounded-2xl p-8 text-center shadow-lg relative z-10 min-h-[320px] flex flex-col gap-8"
                variants={item}
              >
                <h3 className="text-2xl font-sans text-white">Dress Code</h3>
                <motion.div 
            ...
            <div className="relative">
              <motion.div 
                className="bg-[#708565] rounded-2xl p-8 text-center shadow-lg relative min-h-[320px] flex flex-col gap-8"
                variants={item}
              >
                <h3 className="text-2xl font-sans text-white">Música</h3>
                <motion.div 
                  className="flex items-center justify-center mx-auto my-4"
                  whileHover={{ rotate: 15 }}
                >
                ...
                <Button
                  ...
                  variant="secondary"
                  className=" hover:bg-[#F7F6F2]/80 border-[#F7F6F2] text-white hover:text-[#985E4C] px-3 py-1 w-36 mx-auto rounded-xl font-sans"
                >
                  Sugerir canción
                </Button>
              </motion.div>
            ...
            <div className="relative">
              <motion.div 
                ...
                variants={item}
              >
                <h3 className="text-2xl font-sans text-white">Info Adicional</h3>
                <motion.div 
                  className="flex items-center justify-center mx-auto my-4"
                  whileHover={{ rotate: 15 }}
                >
