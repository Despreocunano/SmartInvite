  ...
  return (
    <section className={`relative min-h-screen flex items-center justify-center px-4 ${className}`}>
      ...
      <img
        ...
        className="absolute top-0 left-0 z-30 w-52 md:w-[600px] pointer-events-none select-none"
      ...
      />
        ...
        src={bottomRight}
        alt="Decoración esquina superior izquierda"
        className="absolute bottom-0 right-0 z-30 w-52 md:w-[600px] pointer-events-none select-none"
        style={{ objectFit: 'contain' }}
        draggable={false}
      />
      {/* Imagen detrás del arco */}
      <img
        src={bgImage}
        alt="Flores decorativas"
        className="absolute left-1/2 -top-[40px] md:-top-[160px] -translate-x-1/2 z-0 w-[1000px] pointer-events-none select-none"
        style={{ objectFit: 'contain' }}
        draggable={false}
      />
      ...
      {/* Arco central */}
      <div
        className="relative z-20 bg-[#EFEEE8] w-full max-w-3xl mx-auto min-h-[95vh] flex flex-col items-center justify-center px-4 lg:px-8 py-10 lg:py-20 mt-16 md:mt-20"
      >
        <div className="text-center text-[#708565] w-90% lg:w-1/2 mt-20">
          {/* Names */}
          <motion.div 
            className="mb-12"
          ...
          >
            <h1 className="text-5xl md:text-7xl font-normal uppercase font-ivyora">
              {groomName}
              <span className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-[#C6CBC3]/30 backdrop-blur-sm rounded-full mx-4 md:mx-8 text-3xl md:text-4xl font-ivyora italic">
                &
              </span> 
              {brideName}
            </h1>
