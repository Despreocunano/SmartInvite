          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center">
            {showBankInfo && bankInfo && (
              <motion.button
                ...
                className="bg-[#254637] rounded-xl p-8 shadow-lg border border-[#D4B572]/20 w-full md:w-[400px] hover:bg-[#254637] transition-colors duration-200"
                variants={item}
            ...
            {showCoupleCode && couple_code && store && (
              <div
                className="bg-[#254637] rounded-xl p-8 shadow-lg border border-[#D4B572]/20 w-full md:w-[400px]"
              >
