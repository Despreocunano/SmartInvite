  ...
  return (
    <>
      ...
      >
        ...
        >
         <GiftsIcon /> 
          <h2 className="text-5xl md:text-6xl font-fraunces text-white mb-6">Mesa de Regalos</h2>
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center">
            {showBankInfo && bankInfo && (
              <motion.button
                ...
                className="bg-[#C5A07F] rounded-xl p-8 shadow-lg border border-[#CFD6BA]/20 w-full md:w-[400px]"
                variants={item}
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
                <h3 className="text-xl font-fraunces mb-2 text-[#540B17]">Datos Bancarios</h3>
                <p className="text-[#33040D] text-lg mb-2 font-sans">
            ...
            {showCoupleCode && couple_code && store && (
              <motion.div
                ...
                variants={item}
              >
                <h3 className="text-xl font-fraunces mb-2 text-[#540B17]">Lista de Regalos</h3>
                <p className="text-[#33040D] text-lg mb-2 font-sans">
            ...
            {showWishList && wishListItems.length > 0 && (
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
              >
                <h3 className="text-xl font-fraunces mb-2 text-[#540B17]">Lista de Deseos</h3>
                <p className="text-[#33040D] text-lg mb-2 font-sans">Regalos que nos harían muy felices</p>
                <div className="bg-[#CFD6BA]/30 rounded-lg p-3 h-[72px] flex items-center justify-center">
                  <p className="text-[#33040D] font-sans text-sm">Haz clic para ver nuestra lista de deseos</p>
                </div>
              </motion.button>
            )}
          </div>
