        ...
        <div className="p-8 md:p-10 pt-0 space-y-8">
          <div className="space-y-4 text-center">
            ...
            <div className="flex flex-col items-center">
              <p className="text-lg font-sans text-[#C8A784]">{location}</p>
            </div>
          </div>
          ...
          <div className="space-y-4 text-center">
            ...
            <div className="flex items-center justify-center gap-4">
              <p className="text-lg font-lora text-[#C8A784]">
              ...
              {time && (
                <span className="text-lg font-sans text-[#C8A784]">{time}</span>
              )}
            </div>
          </div>
          ...
          <div className="space-y-4 text-center">
            <h4 className="text-4xl font-fraunces text-white mb-2">Dirección</h4>
              <div className="flex flex-col items-center">
                <p className="text-lg font-sans text-[#C8A784]">{address}</p>
              </div>
            <Button
              onClick={handleOpenMaps}
              className="bg-[#C8A784] hover:bg-[#D0C293] text-[#540B17] px-6 py-2 w-48 mx-auto rounded-full text-base font-sans shadow-sm"
            >
              ¿Cómo llegar?
            </Button>
          </div>
