    ...
    <div className={`w-full ${className}`}>
      ...
      <div className="flex flex-col md:flex-row w-full">
        ...
        <div className="w-full md:w-1/2 h-[57vh] md:h-screen relative">
          ...
          />
          <div className="absolute inset-0 bg-[#440c0c]/40"></div>
        </div>
        ...
        <div className="w-full md:w-1/2 min-h-[20vh] md:min-h-screen flex items-center justify-center pb-16 md:pb-6 relative">
          ...
          <div className="text-center text-[#FFFCE8] max-w-md mx-auto z-20 pt-0 md:pt-14">
            ...
            >
              <div className="inline-block border border-[#C8A784] px-4 py-1 font-fraunces font-bold text-white/90 text-xl tracking-widest uppercase">
                <p>{formattedDate}</p>
              </div>
            </motion.div>
            ...
            >
              <h1 className="text-7xl lg:text-8xl font-extrabold font-fraunces text-[#daa267]">
                {groomName}
            ...
            {welcomeMessage && (
              ...
              >
                <div className="relative">
                  <Quote className="absolute -top-2 -left-0 w-6 h-6 text-[#C8A784] transform rotate-180" />
                  <blockquote className="text-xl md:text-lg lg:text-2xl font-sans leading-relaxed px-6 py-6">
                    {welcomeMessage}
                  </blockquote>
                  <Quote className="absolute -bottom-2 -right-0 w-6 h-6 text-[#C8A784]" />
                </div>
              </motion.div>
            )}
          </div>
