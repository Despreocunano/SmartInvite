      ...
      >
        <div className="max-w-6xl mx-auto">
          <motion.div 
            ...
            variants={item}
          >
            <h2 className="text-5xl md:text-6xl font-fraunces text-[#77ABAF] mb-2">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="relative">
              ...
              {/* Card */}
              <motion.div 
                className="bg-[#31363F] rounded-2xl p-8 text-center shadow-lg relative z-10 min-h-[450px] flex flex-col gap-8"
                variants={item}
              >
                ...
                <h3 className="text-xl font-sans text-[#EEEEEE] mb-4">Una orientación para que elijas tu mejor vestuario</h3>
                <Button
            ...
            <div className="relative">
              ...
              >
                ...
                <h3 className="text-xl font-sans text-[#EEEEEE] mb-4">¿Cuál es la canción que no debe faltar en la playlist de la fiesta?</h3>
                <Button
            ...
            <div className="relative">
              ...
              >
                ...
                <h3 className="text-xl font-sans text-[#EEEEEE] mb-4">Información adicional para tener en cuenta</h3>
                <Button
