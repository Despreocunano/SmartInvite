...
-- Crear función corregida con service_role key
...
BEGIN
  ...
  -- Intentar hacer la llamada HTTP con service_role key
  BEGIN
    PERFORM net.http_post(
      url := 'https://ubpbfnuzcbqtahmxbuft.supabase.co/functions/v1/sync-brevo',
      headers := '{"Content-Type": "application/json", "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVicGJmbnV6Y2JxdGFobXhidWZ0Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0NDkzMjk5NiwiZXhwIjoyMDYwNTA4OTk2fQ.pB-_TA8Z71n8BEyZYbfUIuZCd-rMV3p3xvazD71375Q"}'::jsonb,
